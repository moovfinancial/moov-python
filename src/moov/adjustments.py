...
class Adjustments(BaseSDK):
    def list_adjustments(
        ...
        *,
        security: Union[
            models.ListAdjustmentsSecurity, models.ListAdjustmentsSecurityTypedDict
        ],
        account_id: str,
        ...
        request = models.ListAdjustmentsRequest(
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.ListAdjustmentsSecurity),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.Adjustment])
    ...
    def get_adjustment(
        ...
        *,
        security: Union[
            models.GetAdjustmentSecurity, models.GetAdjustmentSecurityTypedDict
        ],
        account_id: str,
        adjustment_id: str,
        x_moov_version: Optional[models.Versions] = None,
        ...
        request = models.GetAdjustmentRequest(
            x_moov_version=x_moov_version,
            account_id=account_id,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.GetAdjustmentSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="getAdjustment", oauth2_scopes=[], security_source=security
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.Adjustment)
