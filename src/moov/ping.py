...
class Ping(BaseSDK):
    def ping(
        self,
        *,
        security: Union[models.PingSecurity, models.PingSecurityTypedDict],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.PingSecurity),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="ping", oauth2_scopes=[], security_source=security
            ),
            request=req,
