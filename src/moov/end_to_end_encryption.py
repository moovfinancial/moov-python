...
class EndToEndEncryption(BaseSDK):
    def test_end_to_end_token(
        ...
        *,
        security: Union[
            models.TestEndToEndTokenSecurity, models.TestEndToEndTokenSecurityTypedDict
        ],
        token: str,
        ...
        request = models.TestEndToEndTokenRequest(
            x_moov_version=x_moov_version,
            e2_ee_token=models.E2EEToken(
                token=token,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.TestEndToEndTokenSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.e2_ee_token, False, False, "json", models.E2EEToken
            ),
    ...
    def generate_end_to_end_key(
        ...
        *,
        ...
        request = models.GenerateEndToEndKeyRequest(
            x_moov_version=x_moov_version,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.JSONWebKey)
        if utils.match_response(http_res, ["429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
