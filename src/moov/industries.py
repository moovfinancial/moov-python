...
class Industries(BaseSDK):
    def list_industries(
        ...
        *,
        security: Union[
            models.ListIndustriesSecurity, models.ListIndustriesSecurityTypedDict
        ],
        ...
        request = models.ListIndustriesRequest(
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.ListIndustriesSecurity),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.EnrichedIndustry])
