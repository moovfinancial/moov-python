...
class BankAccountAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class ListBankAccountsAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class GetBankAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class CompleteMicroDepositsAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class GetBankAccountVerificationAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class InitiateBankAccountVerificationAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"


class CompleteBankAccountVerificationAcceptEnum(str, Enum):
    APPLICATION_JSON = "application/json"
    TEXT_PLAIN = "text/plain"
...
class BankAccounts(BaseSDK):
    ...
    def bank_account(
        ...
        *,
        account_id: str,
        bank_account_payload: Union[
            models.BankAccountPayload, models.BankAccountPayloadTypedDict
        ],
        x_wait_for: Optional[models.BankAccountsWaitFor] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[BankAccountAcceptEnum] = None,
    ) -> models.BankAccountResponse1:
        r"""Bank account
        ...
        request = models.BankAccountRequest(
            account_id=account_id,
            x_wait_for=x_wait_for,
            bank_account_payload=utils.get_pydantic_model(
                bank_account_payload, models.BankAccountPayload
            ),
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.BankAccountResponse1(
                result=utils.unmarshal_json(http_res.text, models.BankAccountResponse),
                headers={},
            )
        ...
        if utils.match_response(http_res, "default", "text/plain"):
            return models.BankAccountResponse1(result=http_res.text, headers={})
    ...
    def list_bank_accounts(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[ListBankAccountsAcceptEnum] = None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListBankAccountsResponse(
                result=utils.unmarshal_json(
                    http_res.text, List[models.BankAccountResponse]
                ),
                headers={},
            )
        ...
        if utils.match_response(http_res, "default", "text/plain"):
            return models.ListBankAccountsResponse(result=http_res.text, headers={})
    ...
    def get_bank(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[GetBankAcceptEnum] = None,
    ) -> models.GetBankResponse:
        r"""Get bank account
        ...
        if utils.match_response(http_res, "default", "text/plain"):
            return models.GetBankResponse(result=http_res.text, headers={})
    ...
    def delete_bank(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.DeleteBankResponse]:
        ...
        request = models.DeleteBankRequest(
            account_id=account_id,
            bank_account_id=bank_account_id,
        )
        ...
        if utils.match_response(http_res, "204", "*"):
            return models.DeleteBankResponse()
        if utils.match_response(http_res, ["404", "4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
        ...
        if utils.match_response(http_res, "default", "text/plain"):
            return models.DeleteBankResponse(result=http_res.text, headers={})
    ...
    def initiate_micro_deposits(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.InitiateMicroDepositsResponse]:
        ...
        if utils.match_response(http_res, "204", "*"):
            return models.InitiateMicroDepositsResponse()
    ...
    def complete_micro_deposits(
        ...
        *,
        account_id: str,
        bank_account_id: str,
        complete_micro_deposits_request: Union[
            models.CompleteMicroDepositsRequest,
            models.CompleteMicroDepositsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[CompleteMicroDepositsAcceptEnum] = None,
    ) -> models.CompleteMicroDepositsResponse1:
        ...
        :param account_id: ID of the account.
        :param bank_account_id: ID of the bank account
        :param complete_micro_deposits_request:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param accept_header_override: Override the default accept header for this method
        ...
        request = models.CompleteMicroDepositsRequest1(
            account_id=account_id,
            bank_account_id=bank_account_id,
            complete_micro_deposits_request=utils.get_pydantic_model(
                complete_micro_deposits_request, models.CompleteMicroDepositsRequest
            ),
        )
        ...
        req = self.build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.complete_micro_deposits_request,
                False,
                False,
                "json",
                models.CompleteMicroDepositsRequest,
        ...
        http_res = self.do_request(
            ...
            request=req,
            error_status_codes=["404", "409", "429", "4XX", "5XX"],
            retry_config=retry_config,
        )

        if utils.match_response(http_res, "200", "application/json"):
            return models.CompleteMicroDepositsResponse1(
                result=utils.unmarshal_json(
                    http_res.text, models.CompleteMicroDepositsResponse
                ),
                headers={},
            )
        if utils.match_response(http_res, ["404", "409", "4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
            )
    ...
    def get_bank_account_verification(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[GetBankAccountVerificationAcceptEnum] = None,
    ) -> models.GetBankAccountVerificationResponse:
        r"""Check instant verification status
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetBankAccountVerificationResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.BankAccountVerification
                ),
                headers={},
            )
        if utils.match_response(http_res, ["404", "4XX", "5XX"], "*"):
    ...
    def initiate_bank_account_verification(
        ...
        *,
        ...
        accept_header_override: Optional[
            InitiateBankAccountVerificationAcceptEnum
        ] = None,
    ) -> models.InitiateBankAccountVerificationResponse:
        r"""Send instant verification credit
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.InitiateBankAccountVerificationResponse(
                result=utils.unmarshal_json(
    ...
    def complete_bank_account_verification(
        ...
        *,
        account_id: str,
        bank_account_id: str,
        complete_bank_account_verification: Union[
            models.CompleteBankAccountVerification,
            models.CompleteBankAccountVerificationTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[
            CompleteBankAccountVerificationAcceptEnum
        ] = None,
    ) -> models.CompleteBankAccountVerificationResponse1:
        r"""Complete instant verification
        ...
        :param account_id: ID of the account.
        :param bank_account_id: ID of the bank account
        :param complete_bank_account_verification:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param accept_header_override: Override the default accept header for this method
        ...
        request = models.CompleteBankAccountVerificationRequest(
            account_id=account_id,
            bank_account_id=bank_account_id,
            complete_bank_account_verification=utils.get_pydantic_model(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CompleteBankAccountVerificationResponse1(
                result=utils.unmarshal_json(
                    http_res.text, models.CompleteBankAccountVerificationResponse
                ),
                headers={},
            )
        if utils.match_response(http_res, ["404", "409", "4XX", "5XX"], "*"):
