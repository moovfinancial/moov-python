...
class RefundedAmountTypedDict(TypedDict):
...
class DisputedAmountTypedDict(TypedDict):
...
class Transfer1TypedDict(TypedDict):
    ...
    r"""UUID v4"""
    refunded_amount: NotRequired[Nullable[RefundedAmountTypedDict]]
    r"""The total refunded amount for a card transfer, representing one refunded amount, or multiple partial refunded amounts. Contains an integer value and its currency. See the `refunds` array for additional details."""
    refunds: NotRequired[List[GetRefundTypedDict]]
    r"""A list of refunds for a card transfer."""
    disputed_amount: NotRequired[Nullable[DisputedAmountTypedDict]]
    r"""The total disputed amount for a card transfer."""
...
class Transfer1(BaseModel):
    ...
    refunded_amount: Annotated[
        OptionalNullable[RefundedAmount], pydantic.Field(alias="refundedAmount")
    ] = UNSET
    r"""The total refunded amount for a card transfer, representing one refunded amount, or multiple partial refunded amounts. Contains an integer value and its currency. See the `refunds` array for additional details."""
    ...
    disputed_amount: Annotated[
        OptionalNullable[DisputedAmount], pydantic.Field(alias="disputedAmount")
    ] = UNSET
    r"""The total disputed amount for a card transfer."""
...
class Transfer2TypedDict(TypedDict):
    r"""Details about the transfer."""
...
class Transfer3TypedDict(TypedDict):
    r"""Details about the transfer."""
...
class Transfer4TypedDict(TypedDict):
    r"""Details about the transfer."""
