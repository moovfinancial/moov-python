...
GetRoleResponseResultTypedDict = Union[RoleTypedDict, str]


GetRoleResponseResult = Union[Role, str]


class GetRoleResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetRoleResponseResultTypedDict


class GetRoleResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetRoleResponseResult
