...
GetRefundResponseResultTypedDict = Union[GetRefundTypedDict, str]


GetRefundResponseResult = Union[GetRefund, str]


class GetRefundResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetRefundResponseResultTypedDict


class GetRefundResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetRefundResponseResult
