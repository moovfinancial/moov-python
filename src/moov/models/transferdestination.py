...
class TransferDestinationBankAccountTypedDict(TypedDict):
...
class TransferDestinationBankAccount(BaseModel):
    r"""Describes a bank account on a Moov account."""
...
class TransferDestinationWalletTypedDict(TypedDict):
...
class TransferDestinationWallet(BaseModel):
    r"""A Moov wallet to store funds for transfers."""
...
class TransferDestinationBrand(str, Enum):
    r"""The card brand."""
...
class TransferDestinationCvv(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
...
class TransferDestinationAddressLine1(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationPostalCode(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationFirstName(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationLastName(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationMiddleName(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationFullName(str, Enum):
    NO_MATCH = "noMatch"
    MATCH = "match"
    NOT_CHECKED = "notChecked"
    UNAVAILABLE = "unavailable"
...
class TransferDestinationAccountNameTypedDict(TypedDict):
    r"""The results of submitting cardholder name to a card network for verification."""

    first_name: NotRequired[TransferDestinationFirstName]
    last_name: NotRequired[TransferDestinationLastName]
    middle_name: NotRequired[TransferDestinationMiddleName]
    full_name: NotRequired[TransferDestinationFullName]


class TransferDestinationAccountName(BaseModel):
    r"""The results of submitting cardholder name to a card network for verification."""

    first_name: Annotated[
        Optional[TransferDestinationFirstName], pydantic.Field(alias="firstName")
    ] = None

    last_name: Annotated[
        Optional[TransferDestinationLastName], pydantic.Field(alias="lastName")
    ] = None

    middle_name: Annotated[
        Optional[TransferDestinationMiddleName], pydantic.Field(alias="middleName")
    ] = None

    full_name: Annotated[
        Optional[TransferDestinationFullName], pydantic.Field(alias="fullName")
    ] = None


class TransferDestinationCardVerificationTypedDict(TypedDict):
    r"""The results of submitting cardholder data to a card network for verification."""

    cvv: NotRequired[TransferDestinationCvv]
    address_line1: NotRequired[TransferDestinationAddressLine1]
    postal_code: NotRequired[TransferDestinationPostalCode]
    account_name: NotRequired[TransferDestinationAccountNameTypedDict]


class TransferDestinationCardVerification(BaseModel):
    r"""The results of submitting cardholder data to a card network for verification."""

    cvv: Optional[TransferDestinationCvv] = None

    address_line1: Annotated[
        Optional[TransferDestinationAddressLine1], pydantic.Field(alias="addressLine1")
    ] = None

    postal_code: Annotated[
        Optional[TransferDestinationPostalCode], pydantic.Field(alias="postalCode")
    ] = None

    account_name: Annotated[
        Optional[TransferDestinationAccountName], pydantic.Field(alias="accountName")
    ] = None


class TransferDestinationDomesticPushToCard(str, Enum):
...
class TransferDestinationDomesticPullFromCard(str, Enum):
...
class TransferDestinationCardTypedDict(TypedDict):
    ...
    """
    brand: NotRequired[TransferDestinationBrand]
    ...
    card_verification: NotRequired[TransferDestinationCardVerificationTypedDict]
    ...
    domestic_push_to_card: NotRequired[TransferDestinationDomesticPushToCard]
    domestic_pull_from_card: NotRequired[TransferDestinationDomesticPullFromCard]
    payment_methods: NotRequired[List[BasicPaymentMethodTypedDict]]
...
class TransferDestinationCard(BaseModel):
    r"""Describes a card on a Moov account."""
    ...
    brand: Optional[TransferDestinationBrand] = None
    ...
    card_verification: Annotated[
        Optional[TransferDestinationCardVerification],
    ...
    domestic_push_to_card: Annotated[
        Optional[TransferDestinationDomesticPushToCard],
        pydantic.Field(alias="domesticPushToCard"),
    ] = None

    domestic_pull_from_card: Annotated[
        Optional[TransferDestinationDomesticPullFromCard],
...
class TransferDestinationApplePayTypedDict(TypedDict):
...
class TransferDestinationApplePay(BaseModel):
    r"""Describes an Apple Pay token on a Moov account."""
...
class TransferDestinationTypedDict(TypedDict):
    ...
    bank_account: NotRequired[Nullable[TransferDestinationBankAccountTypedDict]]
    wallet: NotRequired[Nullable[TransferDestinationWalletTypedDict]]
    card: NotRequired[Nullable[TransferDestinationCardTypedDict]]
    ach_details: NotRequired[Nullable[ACHDetailsBaseTypedDict]]
    r"""ACH specific details about the transaction."""
    apple_pay: NotRequired[Nullable[TransferDestinationApplePayTypedDict]]
    card_details: NotRequired[Nullable[CardDetailsTypedDict]]
    r"""Card-specific details about the transaction."""
    rtp_details: NotRequired[Nullable[RTPDetailsTypedDict]]
...
class TransferDestination(BaseModel):
    ...
    bank_account: Annotated[
        OptionalNullable[TransferDestinationBankAccount],
        pydantic.Field(alias="bankAccount"),
    ] = UNSET

    wallet: OptionalNullable[TransferDestinationWallet] = UNSET

    card: OptionalNullable[TransferDestinationCard] = UNSET

    ach_details: Annotated[
        OptionalNullable[ACHDetailsBase], pydantic.Field(alias="achDetails")
    ] = UNSET
    r"""ACH specific details about the transaction."""

    apple_pay: Annotated[
        OptionalNullable[TransferDestinationApplePay], pydantic.Field(alias="applePay")
    ] = UNSET
    ...
    rtp_details: Annotated[
        OptionalNullable[RTPDetails], pydantic.Field(alias="rtpDetails")
    ] = UNSET
    r"""RTP specific details about the transaction."""
