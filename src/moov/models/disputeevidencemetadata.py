...
class DisputeEvidenceMetadataEvidenceType(str, Enum):
    RECEIPT = "receipt"
...
class DisputeEvidenceMetadataTypedDict(TypedDict):
    r"""Metadata about the dispute evidence."""
    ...
    evidence_type: NotRequired[DisputeEvidenceMetadataEvidenceType]
...
class DisputeEvidenceMetadata(BaseModel):
    ...
    evidence_type: Annotated[
        Optional[DisputeEvidenceMetadataEvidenceType],
