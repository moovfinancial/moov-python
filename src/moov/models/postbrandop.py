...
class PostBrandSecurityTypedDict(TypedDict):
    basic_auth: NotRequired[SchemeBasicAuthTypedDict]
    o_auth2_auth: NotRequired[str]


class PostBrandSecurity(BaseModel):
...
class PostBrandRequestTypedDict(TypedDict):
    account_id: str
    brand: BrandTypedDict
    x_moov_version: NotRequired[Versions]
    r"""Specify an API version."""


class PostBrandRequest(BaseModel):
    ...
    brand: Annotated[
        Brand, FieldMetadata(request=RequestMetadata(media_type="application/json"))
    ]
