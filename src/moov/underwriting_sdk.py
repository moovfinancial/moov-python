...
class UnderwritingSDK(BaseSDK):
    def get_underwriting(
        ...
        *,
        security: Union[
            models.GetUnderwritingSecurity, models.GetUnderwritingSecurityTypedDict
        ],
        account_id: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.GetUnderwritingSecurity),
    ...
    def update_underwriting(
        ...
        *,
        security: Union[
            models.UpdateUnderwritingSecurity,
            models.UpdateUnderwritingSecurityTypedDict,
        ],
        account_id: str,
        ...
        volume_by_customer_type: Union[
            models.VolumeByCustomerType, models.VolumeByCustomerTypeTypedDict
        ],
        card_volume_distribution: Union[
            models.CardVolumeDistribution, models.CardVolumeDistributionTypedDict
        ],
        fulfillment: Union[
            models.FulfillmentDetails, models.FulfillmentDetailsTypedDict
        ],
        x_moov_version: Optional[models.Versions] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.UpdateUnderwritingRequest(
            x_moov_version=x_moov_version,
            account_id=account_id,
            update_underwriting=models.UpdateUnderwriting(
                ...
                volume_by_customer_type=utils.get_pydantic_model(
                    volume_by_customer_type, models.VolumeByCustomerType
                ),
                card_volume_distribution=utils.get_pydantic_model(
                    card_volume_distribution, models.CardVolumeDistribution
                ),
                fulfillment=utils.get_pydantic_model(
                    fulfillment, models.FulfillmentDetails
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.UpdateUnderwritingSecurity
            ),
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.UpdateUnderwritingErrorData
            )
            raise models.UpdateUnderwritingError(data=data)
        if utils.match_response(http_res, ["500", "504", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
