...
class EnrichedAddress(BaseSDK):
    def get_enrichment_address(
        ...
        *,
        security: Union[
            models.GetEnrichmentAddressSecurity,
            models.GetEnrichmentAddressSecurityTypedDict,
        ],
        search: str,
    ...
    ) -> models.EnrichedAddressResponse:
        ...
        request = models.GetEnrichmentAddressRequest(
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GetEnrichmentAddressSecurity
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.EnrichedAddressResponse)
