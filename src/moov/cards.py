...
class Cards(BaseSDK):
    def register_apple_pay_merchant_domains(
        ...
        *,
        security: Union[
            models.RegisterApplePayMerchantDomainsSecurity,
            models.RegisterApplePayMerchantDomainsSecurityTypedDict,
        ],
        account_id: str,
        ...
        request = models.RegisterApplePayMerchantDomainsRequest(
            ...
            register_apple_pay_merchant_domains=models.RegisterApplePayMerchantDomains(
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.RegisterApplePayMerchantDomainsSecurity
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.ApplePayMerchantDomains)
    ...
    def update_apple_pay_merchant_domains(
        ...
        *,
        security: Union[
            models.UpdateApplePayMerchantDomainsSecurity,
            models.UpdateApplePayMerchantDomainsSecurityTypedDict,
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.UpdateApplePayMerchantDomainsSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def get_apple_pay_merchant_domains(
        ...
        *,
        security: Union[
            models.GetApplePayMerchantDomainsSecurity,
            models.GetApplePayMerchantDomainsSecurityTypedDict,
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetApplePayMerchantDomainsSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def create_apple_pay_session(
        ...
        *,
        security: Union[
            models.CreateApplePaySessionSecurity,
            models.CreateApplePaySessionSecurityTypedDict,
        ],
        account_id: str,
        domain: str,
        display_name: str,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.CreateApplePaySessionSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def link_apple_pay_token(
        ...
        *,
        security: Union[
            models.LinkApplePayTokenSecurity, models.LinkApplePayTokenSecurityTypedDict
        ],
        account_id: str,
        token: Union[models.LinkApplePayToken, models.LinkApplePayTokenTypedDict],
        x_moov_version: Optional[models.Versions] = None,
        billing_contact: Optional[
            Union[models.AppleBillingContact, models.AppleBillingContactTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.LinkApplePayTokenRequest(
            ...
            link_apple_pay=models.LinkApplePay(
                token=utils.get_pydantic_model(token, models.LinkApplePayToken),
                billing_contact=utils.get_pydantic_model(
                    billing_contact, Optional[models.AppleBillingContact]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.LinkApplePayTokenSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.LinkApplePayErrorData)
            raise models.LinkApplePayError(data=data)
        if utils.match_response(http_res, ["500", "504", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def link_card(
        self,
        *,
        security: Union[models.LinkCardSecurity, models.LinkCardSecurityTypedDict],
        account_id: str,
        card_number: str,
        card_cvv: str,
        expiration: Union[models.CardExpiration, models.CardExpirationTypedDict],
        billing_address: Union[models.CardAddress, models.CardAddressTypedDict],
        x_moov_version: Optional[models.Versions] = None,
        x_wait_for: Optional[models.LinkCardWaitFor] = None,
        e2ee: Optional[Union[models.E2EEToken, models.E2EETokenTypedDict]] = None,
        ...
        request = models.LinkCardRequest(
            x_moov_version=x_moov_version,
            x_wait_for=x_wait_for,
            account_id=account_id,
            link_card=models.LinkCard(
                e2ee=utils.get_pydantic_model(e2ee, Optional[models.E2EEToken]),
                card_number=card_number,
                card_cvv=card_cvv,
                expiration=utils.get_pydantic_model(expiration, models.CardExpiration),
                holder_name=holder_name,
                billing_address=utils.get_pydantic_model(
                    billing_address, models.CardAddress
                ),
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.LinkCardSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.link_card, False, False, "json", models.LinkCard
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="linkCard", oauth2_scopes=[], security_source=security
            ),
            request=req,
            error_status_codes=[
                "400",
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.Card)
        if utils.match_response(http_res, ["400", "409"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.GenericErrorData)
            raise models.GenericError(data=data)
        if utils.match_response(http_res, ["401", "403", "404", "429", "4XX"], "*"):
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.LinkCardErrorData)
            raise models.LinkCardError(data=data)
        if utils.match_response(http_res, ["500", "504", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_cards(
        self,
        *,
        security: Union[models.ListCardsSecurity, models.ListCardsSecurityTypedDict],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.ListCardsSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listCards", oauth2_scopes=[], security_source=security
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.Card])
    ...
    def get_card(
        self,
        *,
        security: Union[models.GetCardSecurity, models.GetCardSecurityTypedDict],
        account_id: str,
        card_id: str,
        x_moov_version: Optional[models.Versions] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.GetCardSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="getCard", oauth2_scopes=[], security_source=security
            ),
            request=req,
            error_status_codes=["401", "403", "404", "429", "4XX", "500", "504", "5XX"],
            retry_config=retry_config,
    ...
    def update_card(
        self,
        *,
        security: Union[models.UpdateCardSecurity, models.UpdateCardSecurityTypedDict],
        account_id: str,
        card_id: str,
        x_moov_version: Optional[models.Versions] = None,
        e2ee: Optional[
            Union[models.E2EETokenUpdate, models.E2EETokenUpdateTypedDict]
        ] = None,
        billing_address: Optional[
            Union[models.UpdateCardAddress, models.UpdateCardAddressTypedDict]
        ] = None,
        expiration: Optional[
            Union[models.UpdateCardExpiration, models.UpdateCardExpirationTypedDict]
        ] = None,
        ...
        request = models.UpdateCardRequest(
            ...
            account_id=account_id,
            card_id=card_id,
            update_card=models.UpdateCard(
                e2ee=utils.get_pydantic_model(e2ee, Optional[models.E2EETokenUpdate]),
                billing_address=utils.get_pydantic_model(
                    billing_address, Optional[models.UpdateCardAddress]
                ),
                expiration=utils.get_pydantic_model(
                    expiration, Optional[models.UpdateCardExpiration]
                ),
                card_cvv=card_cvv,
                card_on_file=card_on_file,
                merchant_account_id=merchant_account_id,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.UpdateCardSecurity),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.update_card, False, False, "json", models.UpdateCard
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="updateCard", oauth2_scopes=[], security_source=security
            ),
            request=req,
            error_status_codes=[
                "400",
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.UpdateCardErrorData)
            raise models.UpdateCardError(data=data)
        if utils.match_response(http_res, ["500", "504", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def disable_card(
        ...
        *,
        security: Union[
            models.DisableCardSecurity, models.DisableCardSecurityTypedDict
        ],
        account_id: str,
        card_id: str,
        x_moov_version: Optional[models.Versions] = None,
        ...
        request = models.DisableCardRequest(
            x_moov_version=x_moov_version,
            account_id=account_id,
            card_id=card_id,
        )
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.DisableCardSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="disableCard", oauth2_scopes=[], security_source=security
            ),
            request=req,
            error_status_codes=[
                "400",
