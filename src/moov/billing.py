...
class Billing(BaseSDK):
    def list_fee_plan_agreements(
        ...
        *,
        security: Union[
            models.ListFeePlanAgreementsSecurity,
            models.ListFeePlanAgreementsSecurityTypedDict,
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        agreement_id: Optional[List[str]] = None,
        status: Optional[List[models.FeePlanAgreementStatus]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> List[models.FeePlanAgreement]:
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListFeePlanAgreementsSecurity
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.FeePlanAgreement])
    ...
    def create_fee_plan_agreements(
        ...
        *,
        security: Union[
            models.CreateFeePlanAgreementsSecurity,
            models.CreateFeePlanAgreementsSecurityTypedDict,
        ],
        account_id: str,
        plan_id: str,
        x_moov_version: Optional[models.Versions] = None,
        ...
        request = models.CreateFeePlanAgreementsRequest(
            x_moov_version=x_moov_version,
            account_id=account_id,
            create_fee_plan_agreement=models.CreateFeePlanAgreement(
                plan_id=plan_id,
            ),
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.CreateFeePlanAgreementsSecurity
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, models.FeePlanAgreement)
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.FeePlanAgreementErrorData)
            raise models.FeePlanAgreementError(data=data)
        if utils.match_response(http_res, ["500", "504", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_fee_plans(
        ...
        *,
        security: Union[
            models.ListFeePlansSecurity, models.ListFeePlansSecurityTypedDict
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.ListFeePlansSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="listFeePlans", oauth2_scopes=[], security_source=security
            ),
            request=req,
            error_status_codes=["401", "403", "429", "4XX", "500", "504", "5XX"],
            retry_config=retry_config,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.FeePlan])
        if utils.match_response(http_res, ["401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_partner_pricing(
        ...
        *,
        security: Union[
            models.ListPartnerPricingSecurity,
            models.ListPartnerPricingSecurityTypedDict,
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        plan_i_ds: Optional[List[str]] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.ListPartnerPricingSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.PartnerPricing])
        if utils.match_response(http_res, ["401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_partner_pricing_agreements(
        ...
        *,
        security: Union[
            models.ListPartnerPricingAgreementsSecurity,
            models.ListPartnerPricingAgreementsSecurityTypedDict,
        ],
        account_id: str,
        x_moov_version: Optional[models.Versions] = None,
        agreement_id: Optional[List[str]] = None,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> List[models.PartnerPricingAgreement]:
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.ListPartnerPricingAgreementsSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.PartnerPricingAgreement]
            )
        if utils.match_response(http_res, ["401", "403", "429", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
