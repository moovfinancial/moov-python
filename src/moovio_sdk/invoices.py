...
class Invoices(BaseSDK):
    ...
    def mark_paid_invoice(
        ...
        *,
        ...
        r"""Marks an invoice as paid outside of the Moov platform.
        ...
        request = operations.MarkPaidInvoiceRequest(
            account_id=account_id,
            invoice_id=invoice_id,
            mark_invoice_paid=components.MarkInvoicePaid(
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=operations.MarkPaidInvoiceGlobals(
                x_moov_version=self.sdk_configuration.globals.x_moov_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.mark_invoice_paid,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.MarkInvoicePaidErrorData, http_res
            )
            raise errors.MarkInvoicePaidError(response_data, http_res)
        if utils.match_response(http_res, ["401", "403", "404", "429"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, ["500", "504"], "*"):
    ...
    async def mark_paid_invoice_async(
        self,
        *,
        account_id: str,
        invoice_id: str,
