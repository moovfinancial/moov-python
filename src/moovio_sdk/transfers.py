...
class Transfers(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        :param fee_paid_by: Indicates which party bears fees for a transfer, keyed by fee type.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
    ...
    def list(
        ...
        *,
        account_id: str,
        account_i_ds: Optional[Iterable[str]] = None,
        ...
        request = operations.ListTransfersRequest(
            account_i_ds=utils.unmarshal(account_i_ds, Optional[List[str]]),
            status=status,
    ...
    def batch_get_transfers(
        self,
        *,
        account_id: str,
        transfer_i_ds: Iterable[str],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.BatchGetTransfersResponse:
        r"""Retrieve transfer details for multiple transfers in one request. The response is a map from each
        ...
        request = operations.BatchGetTransfersRequest(
            account_id=account_id,
            batch_get_transfers_request=components.BatchGetTransfersRequest(
                transfer_i_ds=utils.unmarshal(transfer_i_ds, List[str]),
            ),
        )

        req = self._build_request(
            method="POST",
            path="/accounts/{accountID}/transfers/.fetch",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.batch_get_transfers_request,
                False,
                False,
                "json",
                components.BatchGetTransfersRequest,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.BatchGetTransfersResponse(
                result=unmarshal_json_response(
                    Dict[str, components.Transfer], http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, ["401", "403", "429"], "*"):
    ...
    async def batch_get_transfers_async(
        self,
        *,
        account_id: str,
        transfer_i_ds: Iterable[str],
    ...
    def update(
        ...
        *,
        ...
        foreign_id: OptionalNullable[str] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def create_cancellation(
        ...
        *,
        ...
        :param amount: Amount to void. This field can only be set for an auth-capture `card-payment` transfer.
    ...
    def list_cancellations(
        ...
        *,
        ...
        r"""Get a list of cancellations for a transfer.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.ListCancellationsResponse(
    ...
    async def list_cancellations_async(
        self,
        *,
        account_id: str,
        transfer_id: str,
    ...
    def create_capture(
        ...
        *,
        ...
        r"""Create a capture against an auth-capture `card-payment` transfer.
        ...
        :param account_id: Moov account ID of the partner for the transfer.
        :param transfer_id: Identifier for the auth-capture `card-payment` transfer.
        ...
        :param is_final: Indicates whether this is intended to be the final capture.
        ...
        :param line_items: An optional collection of line items for a transfer.
            When line items are provided, their total plus tax must equal the transfer amount.
        :param amount_details:
        :param facilitator_fee_amount: The facilitator fee applied to this capture.
    ...
    def list_captures(
        ...
        *,
        ...
        r"""Get a list of captures for an auth-capture `card-payment` transfer.

        To access this endpoint using an [access token](https://docs.moov.io/api/authentication/access-tokens/)
        you'll need to specify the `/accounts/{accountID}/transfers.read` scope.

        :param account_id: Moov account ID of an authorized partner or the transfer's source or destination.
        :param transfer_id: Identifier for the auth-capture `card-payment` transfer.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
    ...
    def get_capture(
        ...
        *,
        ...
        r"""Get details of a capture for an auth-capture `card-payment` transfer.
    ...
    def initiate_refund(
        ...
        **Use the [Cancel or refund a card transfer](https://docs.moov.io/api/money-movement/refunds/cancel/) endpoint for more comprehensive cancel and refund options.**
        ...
        :param capture_id: ID of the capture to refund. This field is only relevant for an auth-capture `card-payment` transfer.
    ...
    def get_risk_outcomes(
        ...
        *,
        ...
        r"""Retrieve the risk rules that contributed to a transfer's risk decision.
        ...
        :param transfer_id: Identifier for the transfer.
        :param x_account_id: The account the transfer belongs to. When omitted, the account is resolved
        ...
        req = self._build_request(
            method="GET",
            path="/transfers/{transferID}/risk-outcomes",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetTransferRiskOutcomesResponse(
                result=unmarshal_json_response(
                    components.PartnerRiskOutcomesResponse, http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, ["401", "403", "404", "429"], "*"):
    ...
    async def get_risk_outcomes_async(
        self,
        *,
        transfer_id: str,
        x_account_id: Optional[str] = None,
