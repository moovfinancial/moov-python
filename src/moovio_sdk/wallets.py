...
class Wallets(BaseSDK):
    def list_wallets(
        ...
        *,
        security: Union[
            operations.ListWalletsSecurity, operations.ListWalletsSecurityTypedDict
        ],
        account_id: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, operations.ListWalletsSecurity),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[components.Wallet])
    ...
    def get_wallet(
        ...
        *,
        security: Union[
            operations.GetWalletSecurity, operations.GetWalletSecurityTypedDict
        ],
        account_id: str,
        wallet_id: str,
        x_moov_version: Optional[components.Versions] = None,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, operations.GetWalletSecurity),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, components.Wallet)
