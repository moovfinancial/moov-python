...
class BankAccounts(BaseSDK):
    ...
    def create_attestation(
        ...
        *,
        ...
        r"""Submit a new authorization attestation for a bank account in an `errored` status due to an R29 ACH return (`Corporate Customer Advises Not Authorized`).
        ...
        :param account_id:
        :param bank_account_id:
        :param attested_at: Date on which new authorization was obtained from the receiver, formatted as YYYY-MM-DD.
        :param description: Freeform text description describing how the authorization was obtained.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = operations.CreateBankAccountAttestationRequest(
            account_id=account_id,
            bank_account_id=bank_account_id,
            create_bank_account_attestation=components.CreateBankAccountAttestation(
        ...
        req = self._build_request(
            method="POST",
            path="/accounts/{accountID}/bank-accounts/{bankAccountID}/attestations",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.create_bank_account_attestation,
                False,
                False,
                "json",
                components.CreateBankAccountAttestation,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CreateBankAccountAttestationResponse(
                result=unmarshal_json_response(
                    components.BankAccountAttestation, http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, ["400", "409"], "application/json"):
        ...
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.BankAccountAttestationValidationErrorData, http_res
            )
            raise errors.BankAccountAttestationValidationError(response_data, http_res)
        if utils.match_response(http_res, ["401", "403", "404", "429"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, ["500", "504"], "*"):
    ...
    async def create_attestation_async(
        self,
        *,
        account_id: str,
        bank_account_id: str,
    ...
    def list_attestations(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.ListBankAccountAttestationsResponse:
        r"""List the attestations submitted for a bank account.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.ListBankAccountAttestationsResponse(
                result=unmarshal_json_response(
                    List[components.BankAccountAttestationSummary], http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, ["401", "403", "404", "429"], "*"):
    ...
    async def list_attestations_async(
        self,
        *,
        account_id: str,
        bank_account_id: str,
    ...
    def get_attestation_eligibility(
        self,
        *,
        account_id: str,
        bank_account_id: str,
        attested_at: Optional[date] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetBankAccountAttestationEligibilityResponse:
        r"""Check whether a bank account is currently eligible for a new authorization attestation without submitting one.
        ...
        :param account_id:
        :param bank_account_id:
        :param attested_at: Date to check eligibility against, as if it were the `attestedAt` value of a new attestation. Defaults
            to the current date.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        req = self._build_request(
            method="GET",
            path="/accounts/{accountID}/bank-accounts/{bankAccountID}/attestations-eligibility",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetBankAccountAttestationEligibilityResponse(
                result=unmarshal_json_response(
                    components.BankAccountAttestationEligibility, http_res
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.GenericErrorData, http_res)
            raise errors.GenericError(response_data, http_res)
        if utils.match_response(http_res, ["401", "403", "404"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, ["500", "504"], "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    async def get_attestation_eligibility_async(
        self,
        *,
        account_id: str,
        bank_account_id: str,
