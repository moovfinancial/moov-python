...
class ACHDebitTransferProcessingDetailsTypedDict(TypedDict):
    trace_number: str
    return_: NotRequired[ACHExceptionTypedDict]
    correction: NotRequired[ACHExceptionTypedDict]


class ACHDebitTransferProcessingDetails(BaseModel):
...
try:
    ACHDebitTransferProcessingDetails.model_rebuild()
except NameError:
    pass
