...
class PushToApplePayPaymentMethodPaymentMethodType(str, Enum):
    PUSH_TO_APPLE_PAY = "push-to-apple-pay"


class PushToApplePayPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: PushToApplePayPaymentMethodPaymentMethodType
    apple_pay: ApplePayResponseTypedDict
    r"""Describes an Apple Pay token on a Moov account."""


class PushToApplePayPaymentMethod(BaseModel):
...
try:
    PushToApplePayPaymentMethod.model_rebuild()
except NameError:
    pass
