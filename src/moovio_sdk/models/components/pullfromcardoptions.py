...
class PullFromCardOptionsTypedDict(TypedDict):
...
class PullFromCardOptions(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["dynamicDescriptor", "transactionSource"])
...
try:
    PullFromCardOptions.model_rebuild()
except NameError:
    pass
