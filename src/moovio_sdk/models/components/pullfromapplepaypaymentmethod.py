...
class PullFromApplePayPaymentMethodPaymentMethodType(str, Enum):
    PULL_FROM_APPLE_PAY = "pull-from-apple-pay"


class PullFromApplePayPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: PullFromApplePayPaymentMethodPaymentMethodType
    apple_pay: ApplePayResponseTypedDict
    r"""Describes an Apple Pay token on a Moov account."""


class PullFromApplePayPaymentMethod(BaseModel):
...
try:
    PullFromApplePayPaymentMethod.model_rebuild()
except NameError:
    pass
