...
class PushToApplePayTransferPaymentMethodPaymentMethodType(str, Enum):
    PUSH_TO_APPLE_PAY = "push-to-apple-pay"


class PushToApplePayTransferPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: PushToApplePayTransferPaymentMethodPaymentMethodType
    apple_pay: ApplePayResponseTypedDict
    r"""Describes an Apple Pay token on a Moov account."""


class PushToApplePayTransferPaymentMethod(BaseModel):
...
try:
    PushToApplePayTransferPaymentMethod.model_rebuild()
except NameError:
    pass
