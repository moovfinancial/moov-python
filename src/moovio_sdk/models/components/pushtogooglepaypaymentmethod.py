...
class PushToGooglePayPaymentMethodPaymentMethodType(str, Enum):
    PUSH_TO_GOOGLE_PAY = "push-to-google-pay"


class PushToGooglePayPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: PushToGooglePayPaymentMethodPaymentMethodType
    google_pay: GooglePayResponseTypedDict
    r"""Describes a Google Pay token on a Moov account."""


class PushToGooglePayPaymentMethod(BaseModel):
...
try:
    PushToGooglePayPaymentMethod.model_rebuild()
except NameError:
    pass
