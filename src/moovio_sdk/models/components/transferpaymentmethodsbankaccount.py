...
class TransferPaymentMethodsBankAccountTypedDict(TypedDict):
...
class TransferPaymentMethodsBankAccount(BaseModel):
    r"""A bank account as contained within a payment method."""
...
try:
    TransferPaymentMethodsBankAccount.model_rebuild()
except NameError:
    pass
