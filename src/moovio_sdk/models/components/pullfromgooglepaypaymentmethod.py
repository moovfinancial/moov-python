...
class PullFromGooglePayPaymentMethodPaymentMethodType(str, Enum):
    PULL_FROM_GOOGLE_PAY = "pull-from-google-pay"


class PullFromGooglePayPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: PullFromGooglePayPaymentMethodPaymentMethodType
    google_pay: GooglePayResponseTypedDict
    r"""Describes a Google Pay token on a Moov account."""


class PullFromGooglePayPaymentMethod(BaseModel):
...
try:
    PullFromGooglePayPaymentMethod.model_rebuild()
except NameError:
    pass
