...
class AchCreditSameDayTransferPaymentMethodPaymentMethodType(str, Enum):
    ACH_CREDIT_SAME_DAY = "ach-credit-same-day"


class AchCreditSameDayTransferPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: AchCreditSameDayTransferPaymentMethodPaymentMethodType
    bank_account: TransferPaymentMethodsBankAccountTypedDict
    r"""A bank account as contained within a payment method."""


class AchCreditSameDayTransferPaymentMethod(BaseModel):
...
try:
    AchCreditSameDayTransferPaymentMethod.model_rebuild()
except NameError:
    pass
