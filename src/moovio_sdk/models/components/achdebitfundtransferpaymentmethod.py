...
class AchDebitFundTransferPaymentMethodPaymentMethodType(str, Enum):
    ACH_DEBIT_FUND = "ach-debit-fund"


class AchDebitFundTransferPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: AchDebitFundTransferPaymentMethodPaymentMethodType
    bank_account: TransferPaymentMethodsBankAccountTypedDict
    r"""A bank account as contained within a payment method."""


class AchDebitFundTransferPaymentMethod(BaseModel):
...
try:
    AchDebitFundTransferPaymentMethod.model_rebuild()
except NameError:
    pass
