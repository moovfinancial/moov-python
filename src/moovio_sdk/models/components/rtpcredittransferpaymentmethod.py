...
class RtpCreditTransferPaymentMethodPaymentMethodType(str, Enum):
    RTP_CREDIT = "rtp-credit"


class RtpCreditTransferPaymentMethodTypedDict(TypedDict):
    payment_method_id: str
    r"""ID of the payment method."""
    payment_method_type: RtpCreditTransferPaymentMethodPaymentMethodType
    bank_account: TransferPaymentMethodsBankAccountTypedDict
    r"""A bank account as contained within a payment method."""


class RtpCreditTransferPaymentMethod(BaseModel):
...
try:
    RtpCreditTransferPaymentMethod.model_rebuild()
except NameError:
    pass
