...
class TransferPaymentMethodsCardTypedDict(TypedDict):
...
class TransferPaymentMethodsCard(BaseModel):
    r"""A card as contained within a payment method."""
    ...
    @field_serializer("domestic_push_to_card")
    def serialize_domestic_push_to_card(self, value):
        if isinstance(value, str):
            try:
                return components.DomesticPushToCard(value)
            except ValueError:
                return value
        return value

    @field_serializer("domestic_pull_from_card")
    def serialize_domestic_pull_from_card(self, value):
        if isinstance(value, str):
            try:
                return components.DomesticPullFromCard(value)
            except ValueError:
                return value
        return value
...
try:
    TransferPaymentMethodsCard.model_rebuild()
except NameError:
    pass
