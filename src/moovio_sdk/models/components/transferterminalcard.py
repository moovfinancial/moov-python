...
class TransferTerminalCardTypedDict(TypedDict):
    r"""Describes payment card details captured with tap or in-person payment."""

    entry_mode: NotRequired[TransferEntryMode]
...
class TransferTerminalCard(BaseModel):
    r"""Describes payment card details captured with tap or in-person payment."""

    entry_mode: Annotated[
        Optional[TransferEntryMode], pydantic.Field(alias="entryMode")
    ] = None
    r"""How the card information was entered into the point of sale terminal."""
...
try:
    TransferTerminalCard.model_rebuild()
except NameError:
    pass
