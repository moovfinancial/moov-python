...
class DisableCardGlobalsTypedDict(TypedDict):
...
class DisableCardGlobals(BaseModel):
...
class DisableCardRequestTypedDict(TypedDict):
    account_id: str
    card_id: str
...
class DisableCardResponseTypedDict(TypedDict):
