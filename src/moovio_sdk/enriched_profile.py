...
class EnrichedProfile(BaseSDK):
    def get_enrichment_profile(
        ...
        *,
        security: Union[
            operations.GetEnrichmentProfileSecurity,
            operations.GetEnrichmentProfileSecurityTypedDict,
        ],
        email: str,
    ...
    ) -> components.EnrichedBusinessProfile:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, components.EnrichedBusinessProfile
            )
