...
<!-- UsageSnippet language="python" operationID="listAdjustments" method="get" path="/accounts/{accountID}/adjustments" -->
```python
...
with Moov(
    ...
    res = moov.adjustments.list(account_id="c054f3a6-d542-4310-a955-830739f800f0")
...
<!-- UsageSnippet language="python" operationID="getAdjustment" method="get" path="/accounts/{accountID}/adjustments/{adjustmentID}" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
...
with Moov(
    ...
    res = moov.adjustments.get(account_id="3ef4e658-8aaa-449f-a7a4-95a6839172a1", adjustment_id="cbe4a8e7-605f-4667-a308-1afde85cd7a5")
