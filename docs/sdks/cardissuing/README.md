...
<!-- UsageSnippet language="python" operationID="requestCard" method="post" path="/issuing/{accountID}/cards" -->
```python
...
| `controls`                                                                                    | [Optional[components.IssuingControls]](../../models/components/issuingcontrols.md)            | :heavy_minus_sign:                                                                            | Mutable spend controls for the card.                                                          |                                                                                               |
...
<!-- UsageSnippet language="python" operationID="listIssuedCards" method="get" path="/issuing/{accountID}/cards" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
...
| `states`                                                                                                    | List[[components.IssuedCardState](../../models/components/issuedcardstate.md)]                              | :heavy_minus_sign:                                                                                          | Optional, comma-separated states to filter the Moov list issued cards response. For example `active,closed` |                                                                                                             |
| `retries`                                                                                                   | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                            | :heavy_minus_sign:                                                                                          | Configuration to override the default retry behavior of the client.                                         |                                                                                                             |
...
<!-- UsageSnippet language="python" operationID="getIssuedCard" method="get" path="/issuing/{accountID}/cards/{issuedCardID}" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
...
<!-- UsageSnippet language="python" operationID="updateIssuedCard" method="patch" path="/issuing/{accountID}/cards/{issuedCardID}" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
...
<!-- UsageSnippet language="python" operationID="getFullIssuedCard" method="get" path="/issuing/{accountID}/cards/{issuedCardID}/details" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
