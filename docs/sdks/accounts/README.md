...
| `terms_of_service`                                                                                                                                                                                                                                                                                                                                                                                                                                               | [Optional[components.TermsOfServicePayload]](../../models/components/termsofservicepayload.md)                                                                                                                                                                                                                                                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                                                                               | N/A                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<!-- UsageSnippet language="python" operationID="listConnectedAccountsForAccount" method="get" path="/accounts/{accountID}/connected-accounts" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
...
with Moov(
    ...
    res = moov.accounts.list_connected(account_id="7e09ffc8-e508-4fd4-a54e-21cff90a1824", skip=60, count=20)
...
<!-- UsageSnippet language="python" operationID="connectAccount" method="post" path="/accounts/{accountID}/connections" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
