...
with Moov() as moov:
    ...
    res = moov.payment_links.create_payment_link(security=moov.CreatePaymentLinkSecurity(
        ...
        "call_to_action": moov.CallToAction.PAY,
    }, customer={
        "require_phone": True,
    }, payment={
        "allowed_methods": [
            moov.CollectionPaymentMethodType.CARD_PAYMENT,
            moov.CollectionPaymentMethodType.ACH_DEBIT_COLLECT,
        ],
    }, payout={
        "allowed_methods": [
            moov.DisbursementPaymentMethodType.ACH_CREDIT_STANDARD,
        ],
        "recipient": {
...
| ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                        | [models.CreatePaymentLinkSecurity](../../models/createpaymentlinksecurity.md)                                     | :heavy_check_mark:                                                                                                | N/A                                                                                                               |
...
| models.CreatePaymentLinkError | 422                           | application/json              |
...
with Moov() as moov:
    ...
    res = moov.payment_links.list_payment_links(security=moov.ListPaymentLinksSecurity(
        basic_auth=moov.SchemeBasicAuth(
            username="",
            password="",
        ),
...
| Parameter                                                                   | Type                                                                        | Required                                                                    | Description                                                                 |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `security`                                                                  | [models.ListPaymentLinksSecurity](../../models/listpaymentlinkssecurity.md) | :heavy_check_mark:                                                          | N/A                                                                         |
| `account_id`                                                                | *str*                                                                       | :heavy_check_mark:                                                          | N/A                                                                         |
| `x_moov_version`                                                            | [Optional[models.Versions]](../../models/versions.md)                       | :heavy_minus_sign:                                                          | Specify an API version.                                                     |
| `retries`                                                                   | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)            | :heavy_minus_sign:                                                          | Configuration to override the default retry behavior of the client.         |
...
**[List[models.PaymentLink]](../../models/.md)**
...
with Moov() as moov:
    ...
    res = moov.payment_links.get_payment_link(security=moov.GetPaymentLinkSecurity(
        basic_auth=moov.SchemeBasicAuth(
            username="",
            password="",
        ),
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `security`                                                              | [models.GetPaymentLinkSecurity](../../models/getpaymentlinksecurity.md) | :heavy_check_mark:                                                      | N/A                                                                     |                                                                         |
| `account_id`                                                            | *str*                                                                   | :heavy_check_mark:                                                      | N/A                                                                     |                                                                         |
...
with Moov() as moov:
    ...
    res = moov.payment_links.update_payment_link(security=moov.UpdatePaymentLinkSecurity(
        basic_auth=moov.SchemeBasicAuth(
            username="",
            password="",
        ),
...
| Parameter                                                                                           | Type                                                                                                | Required                                                                                            | Description                                                                                         | Example                                                                                             |
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `security`                                                                                          | [models.UpdatePaymentLinkSecurity](../../models/updatepaymentlinksecurity.md)                       | :heavy_check_mark:                                                                                  | N/A                                                                                                 |                                                                                                     |
| `account_id`                                                                                        | *str*                                                                                               | :heavy_check_mark:                                                                                  | N/A                                                                                                 |                                                                                                     |
| `payment_link_code`                                                                                 | *str*                                                                                               | :heavy_check_mark:                                                                                  | N/A                                                                                                 | uc7ZYKrMhi                                                                                          |
| `x_moov_version`                                                                                    | [Optional[models.Versions]](../../models/versions.md)                                               | :heavy_minus_sign:                                                                                  | Specify an API version.                                                                             |                                                                                                     |
...
| ----------------------------- | ----------------------------- | ----------------------------- |
| models.GenericError           | 400, 409                      | application/json              |
| models.UpdatePaymentLinkError | 422                           | application/json              |
| models.APIError               | 4XX, 5XX                      | \*/\*                         |
...
with Moov() as moov:
    ...
    moov.payment_links.disable_payment_link(security=moov.DisablePaymentLinkSecurity(
        basic_auth=moov.SchemeBasicAuth(
            username="",
            password="",
        ),
...
| Parameter                                                                       | Type                                                                            | Required                                                                        | Description                                                                     | Example                                                                         |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `security`                                                                      | [models.DisablePaymentLinkSecurity](../../models/disablepaymentlinksecurity.md) | :heavy_check_mark:                                                              | N/A                                                                             |                                                                                 |
| `account_id`                                                                    | *str*                                                                           | :heavy_check_mark:                                                              | N/A                                                                             |                                                                                 |
| `payment_link_code`                                                             | *str*                                                                           | :heavy_check_mark:                                                              | N/A                                                                             | uc7ZYKrMhi                                                                      |
| `x_moov_version`                                                                | [Optional[models.Versions]](../../models/versions.md)                           | :heavy_minus_sign:                                                              | Specify an API version.                                                         |                                                                                 |
| `retries`                                                                       | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                | :heavy_minus_sign:                                                              | Configuration to override the default retry behavior of the client.             |                                                                                 |
...
with Moov() as moov:
    ...
    res = moov.payment_links.get_payment_link_qr_code(security=moov.GetPaymentLinkQRCodeSecurity(
        basic_auth=moov.SchemeBasicAuth(
            username="",
            password="",
        ),
...
| Parameter                                                                           | Type                                                                                | Required                                                                            | Description                                                                         | Example                                                                             |
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `security`                                                                          | [models.GetPaymentLinkQRCodeSecurity](../../models/getpaymentlinkqrcodesecurity.md) | :heavy_check_mark:                                                                  | N/A                                                                                 |                                                                                     |
| `account_id`                                                                        | *str*                                                                               | :heavy_check_mark:                                                                  | N/A                                                                                 |                                                                                     |
| `payment_link_code`                                                                 | *str*                                                                               | :heavy_check_mark:                                                                  | N/A                                                                                 | uc7ZYKrMhi                                                                          |
| `x_moov_version`                                                                    | [Optional[models.Versions]](../../models/versions.md)                               | :heavy_minus_sign:                                                                  | Specify an API version.                                                             |                                                                                     |
| `retries`                                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                    | :heavy_minus_sign:                                                                  | Configuration to override the default retry behavior of the client.                 |                                                                                     |
...
**[models.GetPaymentLinkQRCodeResponse](../../models/getpaymentlinkqrcoderesponse.md)**
