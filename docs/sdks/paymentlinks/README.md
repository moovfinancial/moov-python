...
with Moov(
    ...
    res = moov.payment_links.update(account_id="ddad6613-2350-446a-883b-f76abb2cd4ea", payment_link_code="uc7ZYKrMhi", amount={
        ...
        "require_phone": True,
    }, payment=components.PaymentLinkPaymentDetailsUpdate(
...
| `sales_tax_amount`                                                                                                                                    | [Optional[components.AmountUpdate]](../../models/components/amountupdate.md)                                                                          | :heavy_minus_sign:                                                                                                                                    | N/A                                                                                                                                                   |                                                                                                                                                       |
