...
| `is_taxable`                                                                                                                                                                                                                                  | *Optional[bool]*                                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                            | Whether applicable tax rules may be applied to this product. True does not guarantee tax is charged; false excludes the product from tax calculation. Omitted values default to true on creation and preserve the existing setting on update. |
...
| `category_id`                                                                                                                                                                                                                                 | *Optional[str]*                                                                                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                                                                                            | The ID of a product taxonomy category to associate with the product.                                                                                                                                                                          |
| `retries`                                                                                                                                                                                                                                     | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                            | Configuration to override the default retry behavior of the client.                                                                                                                                                                           |
...
<!-- UsageSnippet language="python" operationID="listProductCategories" method="get" path="/product-categories" -->
```python
from moovio_sdk import Moov
from moovio_sdk.models import components
